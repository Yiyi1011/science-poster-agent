...
| [frontend/src/Studio.tsx](../frontend/src/Studio.tsx) | 问题输入、自动找资料、右侧真实制作进度、成片自动呈现及证据/修改历史 |
| [frontend/src/studio.css](../frontend/src/studio.css) | 工作台主体布局、制作进度、独立滚动、手机适配和弹窗 |
