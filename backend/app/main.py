...
app.add_middleware(
    ...
    allow_headers=["*"],
    expose_headers=["X-Scivis-Session"],
)
...
async def health() -> dict[str, str | bool]:
    return {"status": "ok", "mock_ai": settings.mock_ai, "region": settings.region, "service": "science-poster-agent", "version": "0.5.9-preview",
