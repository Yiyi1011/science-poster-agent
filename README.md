...
> 当前是**制作过程版**，不是最终交付版。先看[版本导航](docs/versions/README.md)、[代码文件索引](docs/CODE_MAP.md)和[当前变更说明](docs/versions/process/v0.3.0-preview.md)。制作历史与[最终交付区](docs/versions/final/README.md)分开保存，最终版尚未发布。

新版工作台支持问题自动检索入口、公众海报文案与证据分层、6—8镜叙事和留痕修订。自动找资料暂限公开HTML，证据不足会停止。通用分镜预演尚不等于完整有声卡通视频。以下早期能力清单同时包含太阳案例专用流程，不代表全部已泛化。
